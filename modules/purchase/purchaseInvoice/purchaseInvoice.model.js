...
const purchaseInvoiceSchema = new mongoose.Schema(
  {
    ...
    vendorInvoiceNo:  { type: String, trim: true },      // supplier's invoice number
    ...
    grandTotal:   { type: Number, default: 0 }, // Math.round(total)
...
purchaseInvoiceSchema.index({ companyId: 1, invoiceNo: 1, financialYearId: 1 }, { unique: true });
